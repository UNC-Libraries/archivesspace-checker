...
Warbler::Config.new do |config|
  ...
  config.excludes = FileList["config/deploy/*", "config/deploy.rb", "Capfile", "Rakefile", "Readme.md"]
  ...
  # config.gems += ["haml", "sinatra-partial", "sinatra", "ffi", "saxon-xslt", "nokogiri", "schematronium"]
  # config.gems << "tzinfo"
  ...
  # config.gem_excludes = [/^(test|spec|development)\//]
  ...
  # config.excludes.
  config.webinf_files += FileList["config.ru"]
